...
function transactions({hotOnly=false,degraded=false,partial=false}={}){
  const rows=[
    ...
    tx('tx:validation','PROPOSAL_VALIDATED',30,'TRUTH','SETTLEMENT','UNRESOLVED','COMPETING_EVIDENCE_VALID',{sourceRevisionIds:['src:tavern-destroyed:r6','obs:removed-rumor:t418'],affectedArtifactIds:['claim:sun-blade:fate'],outcome:{status:'RECORDED',summary:'Both alternatives retain supporting evidence'},retentionClass:'LARGE_DEBUG_PAYLOAD'}),

...
export class MemoryExternalEvidenceBridge{
  ...
  registerSceneProposal(proposal,options={}){
    ...
    const ownerArtifactRef=normalizeArtifactRef({...proposal.sceneEpisodeRef,owner:proposal.sceneEpisodeRef?.owner??'SCENE_INTELLIGENCE',sceneRevision:proposal.sceneEpisodeRef?.sceneRevision??proposal.sceneRevision},'SceneExperienceProposal.sceneEpisodeRef');

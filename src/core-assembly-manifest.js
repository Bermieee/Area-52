...
'src/cognitive-audit-contracts.js','src/cognitive-audit-plane.js','src/cognitive-audit.js','src/cognitive-choice-contracts.js','src/cognitive-choice-controller.js','src/scene-core-integration.js','src/cognitive-core.js','src/cognitive-reconstruction.js','src/cognitive-repository.js','src/cognitive-transaction-ledger.js','src/conformance-kit.js',
...
'src/event-conformance.js','src/event-registry.js','src/forensic-bundle.js','src/framework-contracts.js','src/framework-kernel.js','src/framework-utils.js','src/generation-publication.js','src/candidate-bus-contracts.js','src/candidate-bus.js','src/retrieval-channel-registry.js','src/retrieval-index-contracts.js','src/retrieval-representation-provider.js','src/retrieval-index-adapters.js','src/retrieval-index-lifecycle.js','src/sensory-net-channels.js','src/sensory-net-backbone.js','src/hot-cognition-contracts.js','src/hot-cognition-context.js','src/hot-cognition-read-model.js','src/hot-cognition-runtime.js',

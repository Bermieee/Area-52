...
export class DevelopmentDeploymentSillyTavernSession {
  ...
  #uiHostBindings(){
    ...
    const nativeKeys=['readSelection','readScene','readHotCognition','readCognitiveChoice','readScatter','readSensoryTrace','readCandidateBusEnvelope','readCandidateFusionReceipt','readTruth','readCorrectiveRetrieval','readJev','readPrecision','readGather','readContextSeal','readRuntimeStatus','readPromptPlan','readContextReceipt','listGenerations','readGeneration'];
